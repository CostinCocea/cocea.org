...
import { experience, projects, education, skills } from '../lib/profile';
export const metadata = {title:'Résumé',description:'Research, projects, machine learning experience, education, and technical skills of Costin Cocea.'};
...
export default function Resume() {
  return <PageShell title="résumé"><div className="resume"><div className="resume-contact"><div><h2>Costin Cocea</h2><p><a href="mailto:cocea@stanford.edu">cocea@stanford.edu</a><span> · </span><a href="https://www.linkedin.com/in/costincocea/" target="_blank" rel="noopener noreferrer">LinkedIn</a><span> · </span><a href="https://cocea.org" target="_blank" rel="noopener noreferrer">cocea.org</a></p></div><PrintResume /></div>
    ...
    <section aria-labelledby="resume-research"><h2 id="resume-research" className="resume-section-title">Research & projects</h2>{projects.map(item=><ResumeEntry key={item.name} item={item}/>)}</section>
